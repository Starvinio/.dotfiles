...
set(0, "MatchParen", { fg = fg, bg = visual, bold = true })
...
-- Characters are primitives like numbers, so they share the fg color
...
set(0, "@lsp.type.function", { fg = fg }) -- reset; declaration modifier below wins
set(0, "@lsp.type.method", { fg = fg })
set(0, "@lsp.typemod.function.declaration", { fg = fg })
set(0, "@lsp.typemod.method.declaration", { fg = fg })
set(0, "@lsp.type.string", { fg = green })
set(0, "@lsp.type.number", { fg = fg })
