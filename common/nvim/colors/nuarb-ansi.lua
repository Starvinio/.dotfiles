...
set(0, "@markup.heading.1.markdown",   {ctermfg = 1, bold = true })
set(0, "@markup.heading.2.markdown",   {ctermfg = 2, bold = true })
set(0, "@markup.heading.3.markdown",   {ctermfg = 3, bold = true })
set(0, "@markup.heading.4.markdown",   {ctermfg = 4, bold = true })
set(0, "@markup.heading.5.markdown",   {ctermfg = 5, bold = true })
set(0, "@markup.heading.6.markdown",   {ctermfg = 6, bold = true })
set(0, "@markup.heading.1.marker.markdown", {ctermfg = 1, bold = true })
set(0, "@markup.heading.2.marker.markdown", {ctermfg = 2, bold = true })
set(0, "@markup.heading.3.marker.markdown", {ctermfg = 3, bold = true })
set(0, "@markup.heading.4.marker.markdown", {ctermfg = 4, bold = true })
set(0, "@markup.heading.5.marker.markdown", {ctermfg = 5, bold = true })
set(0, "@markup.heading.6.marker.markdown", {ctermfg = 6, bold = true })
